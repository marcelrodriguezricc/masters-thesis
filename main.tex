...
% Landsat to introduce multispectral imaging remote sensing
...
\par{Max Planck in 1900, states in his book \textit{The Theory of Heat Radiation} that heat propagates through not only conduction but also radiation, and that heat is identical to light rays of the same length}
