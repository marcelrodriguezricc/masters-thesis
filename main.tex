...
\par{The earliest record of coastal human settlement dates back to the Middle Stone Age, on sections of the African coast that have since been continulously inhabited for over 100,000 years. The biological and behaviroal evolution of Homo Spaiens as a result of adaptation to coastal environments is a deeply studied field of inquiry. Coasts provide for civilization in several ways---including as an abundant source of food and energy resources, and as a gateway for travel, commerce, exploration, and recreation. Humanity's most prolific polymaths: Plato, Aristotle, Galileo Galilei, Rene Descartes, Issac Newton, Daniel Bernoulli, and Pierre-Simon Laplace, have sought to explain phenomena that occurs at the coast. Our understanding of coastal processes has been intrisically linked to our development as a civilization and species; a trend which continues today.}

\par{Most megacities are located in the Low Elevation Coastal Zone (LECZ), which 
represents 2\% of the world’s total land area inhabited by 11\% of the global population.~\textsuperscript{[121]} The number of people living in the LECZ has increased by 200 million from 1990 to 2015, and is projected to reach 1 billion people by 2050.~\textsuperscript{[121]} These areas are especially vulnerable to the damaging effects of coastal processes that are exacerbated by warming global climates---such as sea level rise, coastal erosion, 
and flooding---and so there exists a need for informed solutions to mitigate the impact the ocean has on us and vice versa.~\textsuperscript{[122]} The goal of coastal science is to characterize these processes to inform coastal management projects and other applied use cases.~\textsuperscript{[7]} Coastal environments are exceptionally dynamic---there are several marine and land processes that occur on a range of spatio-temporal scales to influence the hydro- and morphological profile to various extents across discrete coastal sections.~\textsuperscript{[4]} The spatio-temporal sampling requirements for characterizing coastal processes, coupled with the volatile nature of the area, make in-situ sampling difficult and available remote sensing techniques ineffective.~\textsuperscript{[7]} Therefore, novel remote sensing solutions are required.}

\par{Our goal is to aggregate knowledge and review modern practices that pertain to remote sensing of coastal environments for oceanographic and geomorphological field research in order to provide a framework for developing low-cost integrated remote sensing systems for coastal survey and monitoring.}
...
\par{To that end, we will outline coastal processes, the remote sensing technologies able to sample them, the   }
...
% ***** NOTE - TALK ABOUT DATA FUSION OF SATELLITE WITH PROXIMAL SENSORS ****
...
\subsection{Electromagnetic Imaging}

\subsubsection{Optical imaging}

% Intro to electromagnetic imaging sensors, photographic camera
% **** NOTE: MORE DESCRIPTION OF CURRENT OPTICAL IMAGING TECH AND PLATFORMS, USE FOR COASTAL MONITORING *****
...
% Graph of broad electromagnetic radiation bands
...
% ***** NOTE: MORE ABOUT HOW EM CAN BE USED TO QUANTIFY PHENOMENA ****
...
% Other imaging and RADAR platforms
...
% Blue ROV
% ***** NOTE: Generate a new image here with 4 different platforms *****
...
% Inertial Navigation Systems and GNSS
...
% Submerged platforms
% ***** NOTE: TOWED ARRAY SENTENCE NEEDS EDIT *****
...
% ***** NOTE: Generate a unique diagram with graph of mid latitude sound speed profile and axis *****
...
% Proximal sensing and sensing from the ground
% ***** NOTE: GNSS, THEODOLITE, ETC *****
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{images/carte-geometrique.jpg}
...
% ***** NOTE: NEEDS EDITING AND CITATION *****
...
% DEMs as a correction tool for other remote sensors,
...
% DTM vs DSM diagram
% ***** NOTE: GENERATE OWN GRAPHIC HERE *****
...
\begin{enumerate}
    ...
    % 121
    \item{B. Neumann, A. T. Vafeidis, J. Zimmermann, and R. J. Nicholls, “Future Coastal Population Growth and Exposure to Sea-Level Rise and Coastal Flooding - A Global Assessment,” PLOS ONE, vol. 10, no. 3, p. e0118571, Mar. 2015, doi: 10.1371/journal.pone.0118571.}

    % 122
    \item{“The Coming Perfect Storm: Diminishing Sustainability of Coastal Human-Natural Systems in the Anthropocene.” Accessed: Jun. 17, 2025. [Online]. Available: \url{https://www.researchgate.net/publication/373057991_The_Coming_Perfect_Storm_Diminishing_Sustainability_of_Coastal_Human-Natural_Systems_in_the_Anthropocene}}
