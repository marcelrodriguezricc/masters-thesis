...
% Scatterometer
% ***** NOTE: VERIFY SECOND TO LAST SENTENCE. EXPAND UPON LAST SENTENCE. ***** 
...
% Types of sonar
% ***** NOTE: Confirm facts with SAS and backprojection *****
...
\par{Sonar transducers must be couped with the surrounding body of water, and may be deployed from the surface by vessels and buoys, or sub-aqueously by submersibles. Mobile platforms may tow sonar arrays to isolate them from the noise of propulsion systems. Submerged sonar systems may make use of the Sound Fixing and Ranging (SOFAR) channel, a naturally occuring horizontal layer of water that acts as a waveguide for sound, allowing for sound waves to become travel across entire ocean basins. Sonar transducers must be couped with the surrounding body of water, and may be deployed from the surface by vessels and buoys, or sub-aqueously by submersibles. Mobile platforms may tow sonar arrays to isolate them from the noise of propulsion systems. Submerged sonar systems may make use of the Sound Fixing and Ranging (SOFAR) channel, a naturally occuring horizontal layer of water that acts as a waveguide for sound, allowing for sound waves to become travel across entire ocean basins.~\textsuperscript{[91]} The distance from the seafloor by which a multibeam sonar system is deployed gives rise to a tradeoff between resolution and footprint. The closer to the seafloor by which a system can emit a fan of sound beams, the higher the resolution and smaller the footprint. Accuracy generally suffers at distance regardless of the sonar configuration, although as we had discussed previously there are synthtic aperture algorithms for resolving data loss at large distances by correlating phase relationships between ping iterations.}

% Diagram of an ultra short baseline system
% ***** NOTE: Generate a unique diagram
...
\par{The location, attitude, and heading of the sensor aperture is critical for accurate measurement and geolocation of sensed points. Intertial Navigation Systems (INS) combine a complement of sensors---including accelerometers to measure proper acceleration, gyroscopes to detect angular rotation, and magnetometers to detect changes with respect to the Earth's magnetic field---to obtain orientation and positional data. For survey-grade accuracy and to obtain secondary measurements such as heading and depth, INS measurements must be callibrated with global positioning system (GPS) data from GNSS services. GNSS systems are unable to connect with GPS devices underwater, so often a topside (sub-aerial) intermediary platform equipped with GPS maintains the relative location of the underwater platform. A common method for underwater positioning is through acoustic triangulation of a transponder mounted to the underwater platform by transducers on the surface vessel. This type of system is called either a Long, Short, or Ultrashort baseline system (LBL, SBL, USBS) based on the spacing of the transducers on the surface vessel, which is correlated with accuracy.}

% Acoustic navigation. Ultrashort baseline
...
\begin{enumerate}
    ...
    % 78
    \item{“Multispectral multibeam echosounder backscatter data.” Accessed: Jun. 01, 2025. [Online]. \href{https://www.hydro-international.com/content/article/multispectral-multibeam-echosounder-backscatter-data}{Available}}
    ...
    % 80
    \item{“Exploration Tools: Sonar: NOAA Office of Ocean Exploration and Research.” Accessed: Jun. 01, 2025. [Online]. \href{https://oceanexplorer.noaa.gov/technology/sonar/sonar.html}{Available}}

    % 81
    \item{“Exploration Tools: Sub-Bottom Profiler: NOAA Office of Ocean Exploration and Research.” Accessed: Jun. 01, 2025. [Online]. \href{https://oceanexplorer.noaa.gov/technology/sub-bottom-profiler/sub-bottom-profiler.html}{Available}}

    % 82
    \item{“Exploration Tools: Synthetic Aperture Sonar: NOAA Office of Ocean Exploration and Research.” Accessed: Jun. 01, 2025. [Online]. \href{https://oceanexplorer.noaa.gov/technology/sonar/sas.html}{Available}}

    % 83
    \item{J. W. Jamieson, C. Gini, C. Brown, and K. Robert, “Interferometric Synthetic Aperture Sonar: A New Tool for Seafloor Characterization | Oceanography”, Accessed: May 31, 2025. [Online]. \href{https://tos.org/oceanography/article/interferometric-synthetic-aperture-sonar-a-new-tool-for-seafloor-characterization?utm_source}{Available}}
    ...
    % 86
    \item{"Understanding Ocean Acoustics" Accessed: Jun. 02, 2025. [Online]. \href{https://oceanexplorer.noaa.gov/explorations/sound01/background/acoustics/acoustics.html"}{Available}}
    ...
    % 88
    \item{“What is an Expendable Bathythermograph, or ‘XBT’? : Ocean Exploration Facts: NOAA Office of Ocean Exploration and Research.” Accessed: Jun. 02, 2025. [Online]. \href{https://oceanexplorer.noaa.gov/facts/xbt.html}{Available}}

    % 89
    \item {“What does ‘CTD’ stand for? : Ocean Exploration Facts: NOAA Office of Ocean Exploration and Research.” Accessed: Jun. 02, 2025. [Online]. \href{https://oceanexplorer.noaa.gov/facts/ctd.html}{Available}}

    % 90
    \item{“What is a thermocline?” Accessed: Jun. 02, 2025. [Online]. \href{https://oceanservice.noaa.gov/facts/thermocline.html}{Available}}

    % 91
    \item{“NOAA Ocean Explorer: Sounds in the Sea 2001: diagram of how sound travels underwater.” Accessed: Jun. 02, 2025. [Online]. \href{https://oceanexplorer.noaa.gov/explorations/sound01/background/acoustics/media/sofar.html}{Available}}
